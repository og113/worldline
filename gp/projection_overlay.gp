...
file0="data/temp/loop_G_1_B_1_M_0.02_a_0.15_mu_0.13.dat"
file1="data/temp/loop_G_1_B_1_M_0.02_a_0.15_mu_0.134.dat"
file2="data/temp/loop_G_1_B_1_M_0.02_a_0.15_mu_0.138.dat"
file3="data/temp/loop_G_1_B_1_M_0.02_a_0.15_mu_0.142.dat"
file4="data/temp/loop_G_1_B_1_M_0.02_a_0.15_mu_0.146.dat"
file5="data/temp/loop_G_1_B_1_M_0.02_a_0.15_mu_0.15.dat"
...
plot file0 using 3:4 title "{/Symbol m}=0.13" @style lc rgb "black", \
	file1 using 3:4 title "{/Symbol m}=0.134" @style lc rgb "red", \
	file2 using 3:4 title "{/Symbol m}=0.138" @style lc rgb "blue", \
	file3 using 3:4 title "{/Symbol m}=0.142" @style lc rgb "yellow", \
	file4 using 3:4 title "{/Symbol m}=0.146" @style lc rgb "green", \
	file5 using 3:4 title "{/Symbol m}=0.15" @style lc rgb "violet", \
