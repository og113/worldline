...
if (exists("inFile")) {
plot inFile using 0:1 with points lt 1 lc rgb word(colours, 1) t sprintf("x, %s",inFile) noenhanced, \
	inFile using 0:2 with points lt 1 lc rgb word(colours, 2) t sprintf("y, %s",inFile) noenhanced, \
	inFile using 0:3 with points lt 1 lc rgb word(colours, 3) t sprintf("z, %s",inFile) noenhanced, \
	inFile using 0:4 with points lt 1 lc rgb word(colours, 4) t sprintf("t, %s",inFile) noenhanced;
}
